...
export const de: Messages = {
  ...
  sections: {
    ...
    properties: {
      ...
      descriptions: {
        ...
        columnBordersEnabled: "Zeigt vertikale Trennlinien zwischen Spalten. Mit false bleiben nur horizontale Zeilentrenner sichtbar; der äußere Rahmen bleibt erhalten.",
  ...
  themeBuilder: {
    ...
    sizingHints: {
      ...
      radius: "Native Abrundung der äußeren Tabellenecken."
    },
    sizingNote: "Der Radius nutzt das native Token --arcana-border-radius; die übrigen Größenregler erzeugen weiterhin direkte Regeln.",
